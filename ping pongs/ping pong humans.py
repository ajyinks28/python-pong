...
scorer.write("player1: 0", align = "center", font =("courier", 16, "normal"))
scorer.hideturtle()
...
scorer2.write("player2: 0", align = "center", font =("courier", 16, "normal"))
scorer2.hideturtle()
# functions........
...
# for left border..........
	...
	if ball.ycor() > 300:
		...
		player1_score += 1
		scorer.clear()
		scorer.write("player1: {}".format(player1_score), align = "center", font =("courier", 16, "normal"))
	...
	if ball.ycor() < -300:
		...
		player2_score += 1
		scorer2.clear()
		scorer2.write("player2: {}".format(player2_score), align = "center", font =("courier", 16, "normal"))
